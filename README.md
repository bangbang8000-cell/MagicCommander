...
**产品需求文档**：[PRD v2.0](docs/v3-prd/magiccommander-v3-prd-v2/magiccommander-v3-prd-v2.html) | **开发计划与规范**：[Dev Plan v2.0](docs/v3-dev-plan/mc-v3-dev-plan-spec-v2/mc-v3-dev-plan-spec-v2.html)
