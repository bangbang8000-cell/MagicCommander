...
| 版本 | 日期 | 更新内容 |
|------|------|---------|
| **3.0.0** | 2026-07-14 | V3.0 正式版：新增发布版检查更新/下载/重启安装入口，优化终端 help 布局与右键复制，完善日志分类展示，并将 Actions 发布流程调整为仅在版本 tag 推送后触发编译发布 |
...
**产品需求文档**：[PRD v1.0](docs/v3-prd/) | [PRD v2.0（基于代码审查更新）](docs/v3-prd/magiccommander-v3-prd-v2/magiccommander-v3-prd-v2.html) | **开发计划与规范**：[Dev Plan v1.0](docs/v3-dev-plan/) | [Dev Plan v2.0（基于代码审查更新）](docs/v3-dev-plan/mc-v3-dev-plan-spec-v2/mc-v3-dev-plan-spec-v2.html)
