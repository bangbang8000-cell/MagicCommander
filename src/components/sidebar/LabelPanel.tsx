    ...
    <div className="flex flex-col h-full overflow-auto p-3 space-y-3">
      <div className="space-y-1.5">
        ...
        <select
          ...
          className={clsx(
            'w-full text-xs px-2 py-1.5 border rounded focus:outline-none focus:ring-1 focus:ring-primary-500',
          ...
          <div className="space-y-1.5 text-[10px]">
            <div className="flex items-center gap-1">
              ...
              <select
                ...
                className={clsx(
                  'flex-1 px-1 py-0.5 border rounded focus:outline-none focus:ring-1 focus:ring-primary-500',
                  isDark ? 'bg-gray-900 border-gray-600 text-gray-200' : 'bg-white border-gray-300 text-gray-900',
                )}
              >
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                max={32}
                className={clsx(
                  'flex-1 px-1 py-0.5 border rounded w-16 focus:outline-none focus:ring-1 focus:ring-primary-500',
                  isDark ? 'bg-gray-900 border-gray-600 text-gray-200' : 'bg-white border-gray-300 text-gray-900',
                )}
              />
            </div>
