  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      {sidebarVisible && (
        <>
          <div
            className={clsx('flex-shrink-0 overflow-hidden', isDark ? 'bg-gray-900 border-r border-gray-700/50' : 'bg-white border-r border-gray-200')}
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-h-0">
        ...
        {panelVisible && (
          <>
            ...
            <div
              className={clsx('overflow-hidden border-t', isDark ? 'bg-gray-900 border-gray-700/50' : 'bg-white border-gray-200')}
