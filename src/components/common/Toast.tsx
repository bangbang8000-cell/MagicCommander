  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={clsx('ms-auto p-1 rounded hover:bg-black/5 transition-colors', config.textColor)}
      >
        <XCircle size={16} />
      </button>
    </div>
...
export function ToastContainer({ messages, onRemove }: ToastContainerProps) {
  return (
    <div className="fixed top-4 end-4 z-50 flex flex-col gap-2 w-80 max-w-[calc(100vw-2rem)]">
      {messages.map((msg) => (
