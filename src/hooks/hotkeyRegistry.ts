...
export const HOTKEY_REGISTRY: HotkeyDefinition[] = [
  ...
  { combo: 'ctrl+y', label: i18n.t('common:hotkeys.redo'), category: i18n.t('common:hotkeyCategories.edit') },
  { combo: 'ctrl+c', label: i18n.t('common:hotkeys.copySelection'), category: i18n.t('common:hotkeyCategories.edit') },
  { combo: 'ctrl+v', label: i18n.t('common:hotkeys.paste'), category: i18n.t('common:hotkeyCategories.edit') },
...
export const CATEGORY_ORDER = [
  ...
  i18n.t('common:hotkeyCategories.edit'),
